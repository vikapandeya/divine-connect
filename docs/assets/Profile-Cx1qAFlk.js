import{r as $,j as e}from"./vendor-BLqV_m0t.js";import{f as u,D as ne,e as ae,h as ye,i as ve,j as Ne,k as je,m as we,n as Ce,o as $e}from"./index-iOddDAwO.js";import{n as De,P as ke,o as Se,m as M,p as z,S as ie,q as le,R as Ie,D as w,r as E,A as ce,s as Re}from"./icons-dZXZzUTT.js";import{u as Ae,c as Pe}from"./router-BZJXDFZY.js";import"./motion-D5xlclFS.js";const H=595,B=842;function Te(t){return t.replace(/\\/g,"\\\\").replace(/\(/g,"\\(").replace(/\)/g,"\\)")}function ze(t,s){const r=t.split(/\s+/).filter(Boolean);if(r.length===0)return[""];const n=[];let a="";return r.forEach(c=>{const i=a?`${a} ${c}`:c;if(i.length<=s){a=i;return}a&&n.push(a),a=c}),a&&n.push(a),n}function I(t=[.16,.13,.11]){return t.map(s=>Number(s.toFixed(3)))}function Ee(t,s){return Math.max(1,t.length)*s*.52}function We(t,s,r){const n=t.trim();if(!n)return[""];const a=n.split(/\n+/),c=s?Math.max(10,Math.floor(s/Math.max(4,r*.52))):Math.max(10,Math.floor(460/Math.max(4,r*.52)));return a.flatMap((i,l)=>{const b=ze(i,c);return l===0?b:["",...b]})}function Le(t){const s=[],r=t.width??H,n=t.height??B;if(t.backgroundColor){const[a,c,i]=I(t.backgroundColor);s.push(`${a} ${c} ${i} rg`),s.push(`0 0 ${r} ${n} re f`)}return t.elements.forEach(a=>{if(a.type==="rect"){if(s.push("q"),a.fillColor){const[g,x,j]=I(a.fillColor);s.push(`${g} ${x} ${j} rg`)}if(a.strokeColor){const[g,x,j]=I(a.strokeColor);s.push(`${g} ${x} ${j} RG`),s.push(`${a.strokeWidth??1} w`)}s.push(`${a.x} ${a.y} ${a.width} ${a.height} re`),a.fillColor&&a.strokeColor?s.push("B"):a.fillColor?s.push("f"):a.strokeColor&&s.push("S"),s.push("Q");return}if(a.type==="line"){const[g,x,j]=I(a.color??[.8,.76,.7]);s.push("q"),s.push(`${g} ${x} ${j} RG`),s.push(`${a.width??1} w`),s.push(`${a.x1} ${a.y1} m ${a.x2} ${a.y2} l S`),s.push("Q");return}const c=a.size??12,i=a.lineHeight??c+5,[l,b,h]=I(a.color??[.16,.13,.11]),f=We(a.text,a.maxWidth,c);s.push("BT"),s.push(`${l} ${b} ${h} rg`),f.forEach((g,x)=>{const j=a.bold?"F2":"F1",p=Ee(g,c);let S=a.x;a.align==="center"?S=a.x-p/2:a.align==="right"&&(S=a.x-p),s.push(`/${j} ${c} Tf`),s.push(`1 0 0 1 ${S.toFixed(2)} ${(a.y-x*i).toFixed(2)} Tm`),s.push(`(${Te(g)}) Tj`)}),s.push("ET")}),s.join(`
`)}function Oe(t,s=H,r=B){const n=["1 0 obj << /Type /Catalog /Pages 2 0 R >> endobj","2 0 obj << /Type /Pages /Kids [3 0 R] /Count 1 >> endobj",`3 0 obj << /Type /Page /Parent 2 0 R /MediaBox [0 0 ${s} ${r}] /Resources << /Font << /F1 5 0 R /F2 6 0 R >> >> /Contents 4 0 R >> endobj`,`4 0 obj << /Length ${t.length} >> stream
${t}
endstream
endobj`,"5 0 obj << /Type /Font /Subtype /Type1 /BaseFont /Helvetica >> endobj","6 0 obj << /Type /Font /Subtype /Type1 /BaseFont /Helvetica-Bold >> endobj"];let a=`%PDF-1.4
`;const c=[0];n.forEach(l=>{c.push(a.length),a+=`${l}
`});const i=a.length;return a+=`xref
0 ${n.length+1}
`,a+=`0000000000 65535 f 
`,c.slice(1).forEach(l=>{a+=`${l.toString().padStart(10,"0")} 00000 n 
`}),a+=`trailer << /Size ${n.length+1} /Root 1 0 R >>
startxref
${i}
%%EOF`,new Blob([a],{type:"application/pdf"})}function Me(t,s){if(typeof window>"u")return;const r=window.URL.createObjectURL(s),n=window.document.createElement("a");n.href=r,n.download=t.endsWith(".pdf")?t:`${t}.pdf`,n.click(),window.URL.revokeObjectURL(r)}function F(t,s){const r=s.width??H,n=s.height??B,a=Oe(Le(s),r,n);Me(t,a)}const me=842;function m(t){return me-t}function k(t,s){return me-t-s}function U(t){return t?new Date(t).toLocaleString("en-IN"):"Not available"}function R(t){return t?t.split(/[-_\s]+/).filter(Boolean).map(s=>s.charAt(0).toUpperCase()+s.slice(1).toLowerCase()).join(" "):"Pending"}function O(t,s){return`${t}-${s.replace(/[^A-Z0-9]/gi,"").toUpperCase().slice(-12)}`}function He(t){const s=t.items[0],r=t.items.length===1&&(t.itemCount||t.items.length)===1,n=r&&s?`${s.name} Certificate`:"Sacred Product Purchase Certificate",a=r?"Product purchase verification":"Multi-item purchase verification",c=r&&s?`This certificate confirms that ${s.name} was purchased through DivineConnect and recorded with payment details in your order history.`:"This certificate confirms that the listed sacred products were purchased through DivineConnect and recorded with payment details in your order history.";return{title:n,subtitle:a,summary:c,primaryItem:s,hasSingleItem:r}}function D(t,s,r,n,a,c,i){t.push({type:"rect",x:s,y:k(r,a),width:n,height:a,fillColor:i.accentSoft,strokeColor:i.border,strokeWidth:1}),t.push({type:"text",x:s+18,y:m(r+24),text:c.title.toUpperCase(),size:9,bold:!0,color:i.muted});let l=r+50;c.rows.forEach((b,h)=>{t.push({type:"text",x:s+18,y:m(l),text:b.label,size:9,bold:!0,color:i.muted}),t.push({type:"text",x:s+18,y:m(l+16),text:b.value,size:12,bold:h===0,color:i.text,maxWidth:n-36,lineHeight:15}),l+=42})}function q(t){const{theme:s}=t,r=[{type:"rect",x:34,y:34,width:527,height:774,fillColor:s.panel,strokeColor:s.border,strokeWidth:1.5},{type:"rect",x:34,y:784,width:527,height:24,fillColor:s.accent},{type:"rect",x:54,y:616,width:487,height:150,fillColor:s.accentSoft,strokeColor:s.border,strokeWidth:1},{type:"text",x:56,y:m(66),text:"DivineConnect",size:13,bold:!0,color:s.panel},{type:"text",x:540,y:m(66),text:t.footerLabel.toUpperCase(),size:9,bold:!0,color:s.panel,align:"right"},{type:"text",x:297.5,y:m(120),text:t.subtitle.toUpperCase(),size:10,bold:!0,color:s.muted,align:"center"},{type:"text",x:297.5,y:m(154),text:t.title,size:24,bold:!0,color:s.text,align:"center",maxWidth:420,lineHeight:28},{type:"rect",x:184,y:k(188,28),width:227,height:28,fillColor:s.panel,strokeColor:s.border,strokeWidth:1},{type:"text",x:297.5,y:m(207),text:t.documentId,size:10,bold:!0,color:s.text,align:"center"},{type:"text",x:297.5,y:m(254),text:t.recipientLabel.toUpperCase(),size:10,bold:!0,color:s.muted,align:"center"},{type:"text",x:297.5,y:m(286),text:t.recipient,size:23,bold:!0,color:s.text,align:"center",maxWidth:360,lineHeight:27},{type:"text",x:297.5,y:m(330),text:t.summary,size:11,color:s.text,align:"center",maxWidth:390,lineHeight:16}],n=t.cards.slice(0,4);for(;n.length<4;)n.push({title:"Information",rows:[{label:"Status",value:"Available in your DivineConnect profile"}]});D(r,58,394,220,112,n[0],s),D(r,316,394,220,112,n[1],s),D(r,58,526,220,112,n[2],s),D(r,316,526,220,112,n[3],s),r.push({type:"rect",x:58,y:k(660,78),width:478,height:78,fillColor:s.panel,strokeColor:s.border,strokeWidth:1},{type:"text",x:74,y:m(684),text:"Blessing Note",size:9,bold:!0,color:s.muted},{type:"text",x:74,y:m(706),text:t.footerNote,size:11,color:s.text,maxWidth:446,lineHeight:16},{type:"line",x1:74,y1:98,x2:214,y2:98,color:s.border,width:1},{type:"text",x:74,y:82,text:"Digital Verification Desk",size:9,bold:!0,color:s.muted},{type:"line",x1:382,y1:98,x2:522,y2:98,color:s.border,width:1},{type:"text",x:382,y:82,text:"DivineConnect Records",size:9,bold:!0,color:s.muted}),F(t.filename,{backgroundColor:s.background,elements:r})}function Be(t,s,r){var h;const n={background:[.996,.978,.949],hero:[.745,.322,.125],heroSoft:[.973,.875,.741],panel:[1,.995,.986],text:[.247,.176,.122],muted:[.565,.435,.341],border:[.905,.753,.627]},a=(r==null?void 0:r.displayName)||(r==null?void 0:r.email)||"Devotee",c=((h=r==null?void 0:r.addresses)==null?void 0:h[0])||"Address will be shared during confirmation",i=R(s.mode||"online"),l=[{type:"rect",x:0,y:636,width:595,height:206,fillColor:n.hero},{type:"rect",x:34,y:34,width:527,height:774,fillColor:n.panel,strokeColor:n.border,strokeWidth:1.25},{type:"rect",x:58,y:552,width:479,height:198,fillColor:n.panel,strokeColor:n.border,strokeWidth:1},{type:"text",x:297.5,y:m(70),text:"DivineConnect",size:14,bold:!0,color:[1,.986,.955],align:"center"},{type:"text",x:297.5,y:m(108),text:"Sacred Puja Invitation",size:27,bold:!0,color:[1,.986,.955],align:"center"},{type:"text",x:297.5,y:m(140),text:"A devotional card designed for family sharing, event planning, and sacred remembrance.",size:11,color:[1,.935,.846],align:"center",maxWidth:380,lineHeight:15},{type:"rect",x:191,y:k(168,30),width:213,height:30,fillColor:n.heroSoft},{type:"text",x:297.5,y:m(188),text:t,size:10,bold:!0,color:n.text,align:"center"},{type:"text",x:297.5,y:m(262),text:"With blessings and devotion, you are warmly invited to join this sacred occasion.",size:11,color:n.muted,align:"center",maxWidth:360,lineHeight:15},{type:"text",x:297.5,y:m(308),text:s.serviceTitle||"Puja Booking",size:24,bold:!0,color:n.text,align:"center",maxWidth:360,lineHeight:28},{type:"text",x:297.5,y:m(340),text:`Hosted for ${a}`,size:12,color:n.muted,align:"center"}];[{label:"Puja Date",value:s.date,left:84},{label:"Puja Time",value:s.timeSlot,left:223},{label:"Mode",value:i,left:362}].forEach(f=>{l.push({type:"rect",x:f.left,y:k(378,82),width:112,height:82,fillColor:n.heroSoft,strokeColor:n.border,strokeWidth:1},{type:"text",x:f.left+56,y:m(402),text:f.label.toUpperCase(),size:9,bold:!0,color:n.muted,align:"center"},{type:"text",x:f.left+56,y:m(434),text:f.value,size:12,bold:!0,color:n.text,align:"center",maxWidth:88,lineHeight:15})}),D(l,58,492,228,124,{title:"Invitation Details",rows:[{label:"Devotee Name",value:a},{label:"Booking Reference",value:s.bookingReference||s.id}]},{border:n.border,accentSoft:[.994,.969,.925],text:n.text,muted:n.muted}),D(l,308,492,228,124,{title:"Venue and Presence",rows:[{label:"Address",value:c},{label:"Attendance",value:"Family, friends, and close well-wishers are welcome"}]},{border:n.border,accentSoft:[.994,.969,.925],text:n.text,muted:n.muted}),l.push({type:"rect",x:58,y:k(644,96),width:478,height:96,fillColor:[.994,.969,.925],strokeColor:n.border,strokeWidth:1},{type:"text",x:74,y:m(668),text:"Blessings and Note",size:9,bold:!0,color:n.muted},{type:"text",x:74,y:m(692),text:"May this sacred gathering bring peace, blessings, and spiritual strength to the devotee, the family, and every invited guest. Please keep this card for sharing and event coordination.",size:11,color:n.text,maxWidth:446,lineHeight:16},{type:"text",x:74,y:86,text:"Presented with care by DivineConnect",size:10,bold:!0,color:n.muted},{type:"text",x:520,y:86,text:"Sacred service invitation",size:10,color:n.muted,align:"right"}),F(`${t.toLowerCase()}-invitation`,{backgroundColor:n.background,elements:l})}function Fe(t,s){const r=O(t.type==="puja"?"PUJA":"DARSHAN",t.bookingReference||t.id),n=(s==null?void 0:s.displayName)||(s==null?void 0:s.email)||"Devotee";q({filename:`${r.toLowerCase()}-certificate`,title:t.type==="puja"?"Sacred Service Certificate":"Darshan Participation Certificate",subtitle:t.type==="puja"?"Verified booking record":"Verified darshan record",documentId:r,recipientLabel:"Issued To",recipient:n,summary:"This digital certificate confirms that the requested sacred service has been successfully reserved through DivineConnect and recorded in your activity history.",cards:[{title:"Service Overview",rows:[{label:"Service",value:t.serviceTitle||`${R(t.type)} booking`},{label:"Mode",value:R(t.mode||"online")}]},{title:"Schedule",rows:[{label:"Booking Date",value:t.date},{label:"Time Slot",value:t.timeSlot}]},{title:"Verification",rows:[{label:"Reference",value:t.bookingReference||t.id},{label:"Status",value:R(t.status)}]},{title:"Amount Summary",rows:[{label:"Amount",value:`Rs. ${u(t.totalAmount)}`},{label:"Issued On",value:U(t.updatedAt||t.createdAt)}]}],footerNote:"Keep this certificate for support follow-up, service check-in, and future reference inside your DivineConnect profile.",footerLabel:"Digital certificate",theme:{background:[.988,.969,.937],panel:[1,.997,.988],border:[.898,.812,.702],accent:[.812,.357,.118],accentSoft:[.982,.933,.867],text:[.231,.176,.122],muted:[.545,.439,.333]}})}function Ue(t,s){const r=O("INVITE",t.bookingReference||t.id);Be(r,t,s)}function de(t){var c,i,l,b,h,f;const s=O("ORDER",t.orderNumber||t.id),r=He(t),n=t.items.slice(0,2).map(g=>g.name).join(", "),a=t.items.length>2?` +${t.items.length-2} more`:"";q({filename:`${s.toLowerCase()}-certificate`,title:r.title,subtitle:r.subtitle,documentId:s,recipientLabel:"Issued To",recipient:((c=t.customerDetails)==null?void 0:c.fullName)||"DivineConnect Customer",summary:r.summary,cards:[{title:"Product Details",rows:[{label:r.hasSingleItem?"Product Name":"Products",value:r.hasSingleItem&&r.primaryItem?r.primaryItem.name:`${n}${a}`},{label:"Category / Quantity",value:r.hasSingleItem&&r.primaryItem?`${r.primaryItem.category} | Qty ${r.primaryItem.quantity}`:`${t.items.length} items in this purchase`}]},{title:"Source and Pricing",rows:[{label:"Temple / Source",value:((i=r.primaryItem)==null?void 0:i.templeName)||((l=r.primaryItem)==null?void 0:l.category)||"DivineConnect marketplace selection"},{label:"Total Amount",value:`Rs. ${u(t.totalAmount)}`}]},{title:"Payment Snapshot",rows:[{label:"Payment Method",value:((b=t.receipt)==null?void 0:b.paymentMethod)||"Secure checkout"},{label:"Payment Status",value:R(((h=t.receipt)==null?void 0:h.paymentStatus)||"Paid")}]},{title:"Order Trace",rows:[{label:"Order Number",value:t.orderNumber||t.id.slice(-6).toUpperCase()},{label:"Issued On",value:U(((f=t.receipt)==null?void 0:f.issuedAt)||t.createdAt)}]}],footerNote:"Use this certificate together with the invoice for recordkeeping, product verification, customer support, and delivery reconciliation.",footerLabel:"Product certificate",theme:{background:[.958,.978,.975],panel:[.994,.998,.997],border:[.741,.843,.816],accent:[.09,.451,.408],accentSoft:[.903,.957,.944],text:[.101,.2,.196],muted:[.314,.427,.408]}})}function qe(t){const s=O("KUNDALI",t.id);q({filename:`${s.toLowerCase()}-certificate`,title:"Kundali Match Certificate",subtitle:"Compatibility reading record",documentId:s,recipientLabel:"Primary Profile",recipient:t.name,summary:"This certificate confirms that a compatibility reading was generated in the DivineConnect Kundali Match experience and stored as a devotional reference.",cards:[{title:"Primary Details",rows:[{label:"Birth Details",value:`${t.dob} | ${t.tob} | ${t.pob}`},{label:"Reading Type",value:t.readingType==="kundali-match"?"Kundali Match":"Astrology Reading"}]},{title:"Partner Details",rows:[{label:"Partner Name",value:t.partnerName||"Not provided"},{label:"Partner Birth",value:`${t.partnerDob||"N/A"} | ${t.partnerTob||"N/A"} | ${t.partnerPob||"N/A"}`}]},{title:"Reading Log",rows:[{label:"Issued On",value:U(t.createdAt)},{label:"Reference",value:s}]},{title:"Use Case",rows:[{label:"Document Type",value:"Digital compatibility certificate"},{label:"Storage",value:"Saved inside the DivineConnect astrology profile"}]}],footerNote:"This certificate is intended for personal reference and devotional recordkeeping inside the DivineConnect experience.",footerLabel:"Astrology certificate",theme:{background:[.969,.96,.988],panel:[.996,.994,1],border:[.815,.788,.902],accent:[.337,.255,.639],accentSoft:[.937,.921,.988],text:[.176,.153,.286],muted:[.396,.357,.525]}})}const Ge=842;function d(t){return Ge-t}function v(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function xe(t,s){return t.length<=s?t:`${t.slice(0,Math.max(0,s-1)).trimEnd()}...`}function _e(t){const s=t.customerDetails||{addressLine1:"",city:"",state:"",pincode:""};return[s.addressLine1,s.addressLine2,`${s.city}, ${s.state} - ${s.pincode}`].filter(Boolean).join(", ")}function pe(t){const s=t.orderNumber||`ORDER-${t.id.slice(-6).toUpperCase()}`,r=t.receipt||{orderNumber:s,issuedAt:t.createdAt,paymentMethod:"Secure checkout",paymentStatus:"Paid",transactionId:"Generated at checkout",subtotal:t.totalAmount,shippingFee:0,totalAmount:t.totalAmount},n=t.customerDetails||{fullName:"DivineConnect Customer",email:"Not provided",phoneNumber:"Not provided",addressLine1:t.shippingAddress||"Address not available",city:"",state:"",pincode:""};return{orderNumber:s,receipt:r,customerDetails:n,invoiceDate:new Date(r.issuedAt||t.createdAt).toLocaleString("en-IN"),shippingAddress:_e(t)||t.shippingAddress||"Address not available"}}function Ve(t){const{orderNumber:s,receipt:r,customerDetails:n,invoiceDate:a,shippingAddress:c}=pe(t),i=t.items.map(l=>`
        <tr>
          <td>
    ...
    <div class="sheet">
      <section class="hero">
        ...
        <div class="hero-meta">
          ...
          <p><strong>Issued On:</strong> ${v(a)}</p>
