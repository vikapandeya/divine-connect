...
const fallbackProducts = [
  {
    ...
    description: 'Handcrafted pure brass Ganesha idol for your home altar. Intricately detailed with traditional motifs.',
    price: 1299,
    category: 'Idols',
    rating: 4.8,
  ...
  },
  {
    ...
    description: 'Premium Mysore sandalwood incense sticks. Each stick burns for 45–60 minutes filling your space with a calming, divine aroma.',
    price: 250,
    category: 'Incense',
    rating: 4.5,
  ...
  },
  {
    id: '3',
    name: 'Rudraksha Mala',
    description: 'Original 108+1 beads Panchmukhi Rudraksha mala from Nepal. Energized and blessed, ideal for meditation and japa.',
    price: 599,
    category: 'Mala',
    rating: 4.9,
  ...
  },
  {
    id: '4',
    name: 'Bhagavad Gita',
    description: 'The Bhagavad Gita As It Is — Deluxe hardbound edition with original Sanskrit, transliteration, and commentary.',
    price: 450,
    category: 'Books',
    rating: 5.0,
  ...
  },
  {
    ...
    description: 'Energized copper Shri Yantra for prosperity and positive energy. Geometrically precise, consecrated as per Vedic rituals.',
    price: 899,
    category: 'Yantras',
    rating: 4.7,
  ...
  },
  {
    ...
    description: 'Special Ladoo Prasad from Kashi Vishwanath Temple, Varanasi. Freshly prepared and dispatched with temple blessings.',
    price: 250,
    category: 'Prasad',
    rating: 4.9,
  ...
  },
  {
    id: '7',
    name: 'Tirupati Laddu',
    description: 'Authentic Tirupati Balaji Temple Laddu Prasad. Prepared by temple priests using the original sacred recipe.',
    price: 350,
    category: 'Prasad',
    rating: 5.0,
  ...
  },
  {
    ...
    description: 'Handcrafted brass diya with intricate engravings. Perfect for daily puja, Diwali, and auspicious occasions.',
    price: 499,
  ...
  },
  {
    ...
    description: 'Complete puja samagri kit with all essentials — kumkum, haldi, chandan, camphor, dhoop, supari, and more.',
    price: 349,
