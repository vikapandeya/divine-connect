...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>PunyaSeva Invoice ${escapeHtml(orderNumber)}</title>
    <style>
      :root {
        --ink: #18212b;
        --muted: #5b6773;
  ...
  <body>
    <div class="sheet">
      <section class="hero">
        <div>
          <div class="eyebrow">PunyaSeva Finance Desk</div>
      ...
      <section class="panel">
        ...
        <div class="footer-note">
          This invoice is generated by PunyaSeva for order support, print records, and payment reconciliation.
        </div>
      </section>
    </div>
  </body>
...
function buildInvoicePdfElements(order: Order): PdfElement[] {
  ...
  const elements: PdfElement[] = [
    ...
    },
    {
      ...
      x: 58,
      y: textYFromTop(126),
      text: 'Clear billing proof for support, delivery reconciliation, and payment verification inside the PunyaSeva experience.',
      size: 10,
    ...
    },
    {
      ...
      x: 76,
      y: textYFromTop(234),
      text: customerDetails.fullName || 'PunyaSeva Customer',
      size: 15,
      bold: true,
  ...
  elements.push(
    ...
    },
    {
      ...
      x: 58,
      y: 52,
      text: 'Generated by PunyaSeva for sacred commerce records.',
      size: 9,
      color: [0.353, 0.404, 0.463],
    },
    {
